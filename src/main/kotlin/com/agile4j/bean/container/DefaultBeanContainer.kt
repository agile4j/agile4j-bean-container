...
import com.agile4j.bean.container.aspect.BeanAspectResolver
import com.agile4j.bean.container.definition.BeanConstructorResolver
import com.agile4j.bean.container.definition.BeanDefinition
import com.agile4j.bean.container.definition.BeanPropertyValueConverter
import com.agile4j.bean.container.exception.BeanCreationException
import com.agile4j.bean.container.exception.BeanDefinitionException
import com.agile4j.bean.container.parser.BeanParser
import com.agile4j.bean.container.parser.SupportedFileTypeEnum
import com.agile4j.bean.container.resource.ClassPathResource
...
import com.agile4j.utils.util.MapUtil.getFromMapForcibly
...
class DefaultBeanContainer(private val resource: Resource,
    ...
    private fun initContainer() {
        try {
            ...
            throw BeanCreationException(
                "unable to instantiate singleton bean: ${e.message}",
                e
            )
    ...
    override fun getBean(beanId: String): Any {
        ...
        try {
            ...
            throw BeanCreationException(
                "create bean for '$beanId' failed. ${e.message ?: ""}", e
            )
        }
    }
