...
import com.agile4j.utils.util.StringUtil
...
import com.agile4j.bean.container.definition.BeanPropertyValueType
...
class YAMLBeanParser : BeanParser {
    ...
    private fun parseConstructorArgs(element: Map<String, Any>, definition: BeanDefinition) {
        ...
        constructorArgs.forEach {
            ...
            val constructorArg =
                BeanConstructorArg(index, type!!, constructorArgValue)
    ...
    private fun beanValueOf(propElement: Map<String, Any>, elementDesc: String): BeanPropertyValue {
        ...
        return when {
            isRefAttr -> {
                ...
                BeanPropertyValue(
                    refName,
                    BeanPropertyValueType.RUNTIME_BEAN_REFERENCE_TYPE
                )
            }
            isValueAttr -> {
                BeanPropertyValue(
                    StringUtil.getString(propElement[valueKey]),
                    BeanPropertyValueType.BASIC_TYPE
                )
            }
